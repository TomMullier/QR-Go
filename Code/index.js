...
app.get("/login", (req, res) => {
	if (!req.session.mail) {
		res.sendFile(__dirname + "/Vue/HTML/login.html"); //? redirect
	} else {
		res.redirect(__dirname + "/Vue/HTML/user_route_list.html");
	}
});
...
app.get("/register", (req, res) => {
	if (req.session.mail) {
		res.sendFile(__dirname + "/Vue/HTML/user_route_list.html"); //? redirect
	} else {
...
app.post(
	...
	(req, res) => {
		...
		let mail = req.body.mail;
		let name = "marcelo"; //! req.body.name;
		let surname = "campion"; //! req.body.surname;
		let password = req.body.password;
